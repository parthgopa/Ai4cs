...
const CustomNote = ({ onGenerate }) => {
  const [formData, setFormData] = useState({
    purpose: "",
    noteType: "Custom Note",
    subject: "",
    context: "",
    dateTimeReference: "",
    keyPoints: "",
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onGenerate("custom-note", formData);
  };
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input
            ...
            placeholder="Specify the purpose of this note"
            required
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={handleChange}
            className="form-control"
            placeholder="e.g., Today, Specific date, Time period"
          />
        </div>
        ...
        <div className="form-group">
          <label className="form-label">Facts, Observations, or Details</label>
          <textarea
            name="factsObservations"
            value={formData.factsObservations}
            onChange={handleChange}
            className="form-control"
            placeholder="Relevant facts, observations, or specific details"
            rows="3"
          />
        </div>
        ...
        <div className="form-group">
          <label className="form-label">Decisions, Outcomes, or Next Steps</label>
          <textarea
            name="decisionsOutcomes"
            value={formData.decisionsOutcomes}
            onChange={handleChange}
            className="form-control"
            placeholder="Any decisions, outcomes, or next steps to include"
            rows="2"
          />
        </div>
