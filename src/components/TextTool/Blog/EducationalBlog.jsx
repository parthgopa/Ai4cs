...
function EducationalBlog({ onGenerate }) {
  ...
  const handleSubmit = (e) => {
    ...
    onGenerate("educational-blog", formData);
  };

  return (
    <div className="form-card">
      <h3 className="form-section-title">Educational/Explainer Blog</h3>
      ...
      <div className="form-group">
        ...
        <input
          ...
          onChange={handleChange}
          placeholder="e.g., How AI Works, What is Blockchain?, Beginner Guide to React"
          className="form-control"
          required
        />
      </div>
      ...
      <div className="form-grid">
        ...
        <div className="form-group">
          ...
          <select
            ...
            value={formData.includeExamples}
            onChange={handleChange}
            className="form-control"
          >
